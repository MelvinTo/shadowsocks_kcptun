...
import (
	...
	"github.com/shadowsocks-plus/kcptun-integration/kcptunClient"
)
...
func main() {
	...
	go kcptunClient.RunClient(cmdServer + ":" + strconv.Itoa(config.ServerPort+10000),"127.0.0.1:"+strconv.Itoa(config.ServerPort+10001))
